...
export const MOCK_CONTRAINDICATIONS: Contraindication[] = [
  ...
  { id: 13, name: 'Аллергия на дрожжи', category: 'Аллергии', popularity: 70 },
  {
    id: 14,
  ...
  // Иммунодефициты
  { id: 16, name: 'ВИЧ', category: 'Иммунодефициты', popularity: 70 },
  { id: 17, name: 'ВИЧ у матери', category: 'Иммунодефициты', popularity: 65 },
  {
    id: 18,
